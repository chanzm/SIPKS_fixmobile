...
public class GajiFragment extends Fragment {
    ...
    public void cari()
    {
        ...
        Call<Response1Transfer> cari = api.duatunai(Constans.getId_sekolah(),"Bearer "+Constans.getToken());
...
//                Log.d(TAG, "onResponse: "+barangs);
        ...
        Call<Response1Transfer> dua = api.duatransfer(Constans.getId_sekolah(),"Bearer "+Constans.getToken());
