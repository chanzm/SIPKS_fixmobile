package id.ac.its.attendance.Rule.Kepala.Bopda.Fragment;
...
public class LainFragment extends Fragment {
    ...
    public void cari()
    {
        ...
        Call<Response1Transfer> cari = api.tigatunai(Constans.getId_sekolah(),"Bearer "+Constans.getToken());
...
//                Log.d(TAG, "onResponse: "+barangs);
        ...
        Call<Response1Transfer> dua = api.tigatransfer(Constans.getId_sekolah(),"Bearer "+Constans.getToken());
