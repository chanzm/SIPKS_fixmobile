...
import id.ac.its.attendance.Rule.Kepala.Bopda.Activity.TunaiBarangActivity;
...
public class KAdapterBarangTunai extends RecyclerView.Adapter<KAdapterBarangTunai.Holder> {
    private Context context;
    private List<Data1Transfer> barangs;

    public KAdapterBarangTunai(List<Data1Transfer>barangs, Context context)
    {
    ...
    @NonNull
    @Override
    public KAdapterBarangTunai.Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rc_main, viewGroup, false);
        return new KAdapterBarangTunai.Holder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull KAdapterBarangTunai.Holder holder, final int i) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, TunaiBarangActivity.class);
