 ...
 */
public class KGajiFragment extends Fragment {

    private List<Data1Transfer> barangs,barang1;
    private RecyclerView rc,rc2;
    private TextView kosong,kosong2;
    SwipeRefreshLayout swipeRefreshLayout;
    private KAdapaterGajiTransfer adapterBarang;
    private KAdapaterGajiTunai adapaterGajiTunai;
    public KGajiFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kgaji, container, false);
        rc = view.findViewById(R.id.rc_gaji_tunai);
        kosong = view.findViewById(R.id.kosong_gaji_tunai);
        rc2 = view.findViewById(R.id.rc_gaji_transfer);
        kosong2 = view.findViewById(R.id.kosong_gaji_transfer);
        swipeRefreshLayout = view.findViewById(R.id.gaji);
    ...
    public void cari()
    {
        ...
        Call<Response1Transfer> cari = api.duatunai1(Constans.getId_sekolah(),"Bearer "+Constans.getToken());
...
//                Log.d(TAG, "onResponse: "+barangs);
                    ...
                    else
                    {
                        ...
                        adapaterGajiTunai = new KAdapaterGajiTunai(barangs,getActivity());
                        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
                        rc.setLayoutManager(mLayoutManager);
                        rc.setItemAnimator(new DefaultItemAnimator());
                        rc.setAdapter(adapaterGajiTunai);
        ...
        Call<Response1Transfer> dua = api.duatransfer1(Constans.getId_sekolah(),"Bearer "+Constans.getToken());
...
//                Log.d(TAG, "onResponse: "+barangs);
                    ...
                    else
                    {
                        ...
                        adapterBarang = new KAdapaterGajiTransfer(barang1,getActivity());
                        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
