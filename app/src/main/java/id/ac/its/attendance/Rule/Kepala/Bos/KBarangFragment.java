...
import id.ac.its.attendance.Rule.Kepala.Bopda.Fragment.Barang.KAdapterBarangTransfer;
import id.ac.its.attendance.Rule.Kepala.Bopda.Fragment.Barang.KAdapterBarangTunai;
 ...
 */
public class KBarangFragment extends Fragment {

    private List<Data1Transfer> barangs,barang1;
    private RecyclerView rc,rc2;
    private TextView kosong_tunai,kosong_transfer;
    private KAdapterBarangTunai adapterBarang;
    private KAdapterBarangTransfer adapterBarangTransfer;
    private SwipeRefreshLayout swipeRefreshLayout;
    public KBarangFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kbarang, container, false);
        rc = view.findViewById(R.id.rc_barang_tunai);
        rc2=view.findViewById(R.id.rc_barang_transfer);
        kosong_tunai = view.findViewById(R.id.kosong_barang_tunai);
        kosong_transfer = view.findViewById(R.id.kosong_barang_transfer);
        swipeRefreshLayout = view.findViewById(R.id.kepalabarang);
    ...
    public void cari()
    {
        ...
        Call<Response1Transfer> cari = api.satutunai1(Constans.getId_sekolah(),"Bearer "+Constans.getToken());
...
//                Log.d(TAG, "onResponse: "+barangs);
                    ...
                    else
                    {
                        ...
                        adapterBarang = new KAdapterBarangTunai(barangs,getActivity());
        ...
        Call<Response1Transfer> trans = api.satutranfer1(Constans.getId_sekolah(),"Bearer "+Constans.getToken());
...
//                Log.d(TAG, "onResponse: "+barangs);
                    ...
                    else
                    {
                        ...
                        adapterBarangTransfer = new KAdapterBarangTransfer(barang1,getActivity());
                        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
                        rc2.setLayoutManager(mLayoutManager);
                        rc2.setItemAnimator(new DefaultItemAnimator());
                        rc2.setAdapter(adapterBarangTransfer);
