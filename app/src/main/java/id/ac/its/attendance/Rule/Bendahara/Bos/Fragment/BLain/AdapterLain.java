...
import id.ac.its.attendance.Rule.Bendahara.Bos.Activity.DetailTransaksiGajiActivity;
...
public class AdapterLain extends RecyclerView.Adapter<AdapterLain.Holder> {
    private Context context;
    private List<Data1Transfer> barangs;
    public AdapterLain(List<Data1Transfer>barangs, Context context)
    {
    ...
    @NonNull
    @Override
    public AdapterLain.Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rc_main, viewGroup, false);
        return new AdapterLain.Holder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterLain.Holder holder, final int i) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DetailTransaksiGajiActivity.class);
