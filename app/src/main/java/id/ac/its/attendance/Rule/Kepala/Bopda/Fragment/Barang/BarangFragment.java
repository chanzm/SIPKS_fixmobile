package id.ac.its.attendance.Rule.Kepala.Bopda.Fragment.Barang;
...
public class BarangFragment extends Fragment {
    ...
    public void cari()
    {
        ...
        Call<Response1Transfer> cari = api.satutunai(Constans.getId_sekolah(),"Bearer "+Constans.getToken());
...
//                Log.d(TAG, "onResponse: "+barangs);
        ...
        Call<Response1Transfer> trans = api.satutranfer(Constans.getId_sekolah(),"Bearer "+Constans.getToken());
