...
import id.ac.its.attendance.Rule.Bendahara.Bos.Fragment.BLain.AdapterLain;
 ...
 */
public class BBLainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bblain, container, false);
    ...
    public void cari() {
        ...
        Call<Response1Transfer> cari = api.bendaharatigatunai1(Constans.getId_sekolah(), "Bearer " + Constans.getToken());
...
//                    Log.d(TAG, "onResponse: " + barangs);
        ...
        Call<Response1Transfer> trans = api.bendaharatigatransfer1(Constans.getId_sekolah(), "Bearer " + Constans.getToken());
