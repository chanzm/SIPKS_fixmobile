...
public class KAdapterBarangTransfer extends RecyclerView.Adapter<KAdapterBarangTransfer.Holder> {
    private Context context;
    private List<Data1Transfer> barangs;

    public KAdapterBarangTransfer(List<Data1Transfer>barangs, Context context)
    {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new KAdapterBarangTransfer.Holder(itemView);
    }
        ...
        else
        {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context, TransferBarangActivity.class);
