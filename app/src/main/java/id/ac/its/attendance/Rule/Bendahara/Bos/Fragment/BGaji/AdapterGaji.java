...
public class AdapterGaji extends RecyclerView.Adapter<AdapterGaji.Holder> {
    private Context context;
    private List<Data1Transfer> barangs;
    public AdapterGaji(List<Data1Transfer>barangs, Context context)
    {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new AdapterGaji.Holder(itemView);
    }
