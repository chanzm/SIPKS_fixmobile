 ...
 */
public class BBarangFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bbarang, container, false);
    ...
    public void cari() {
        ...
        Call<Response1Transfer> cari = api.bendaharasatutunai(Constans.getId_sekolah(), "Bearer " + Constans.getToken());
...
//                Log.d(TAG, "onResponse: " + barangs);
        ...
        Call<Response1Transfer> trans = api.bendaharasatutransfer(Constans.getId_sekolah(), "Bearer " + Constans.getToken());
