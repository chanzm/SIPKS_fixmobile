package id.ac.its.attendance.Rule.Bendahara.Bos.Fragment.BGaji;
 ...
 */
public class BGajiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_kota, container, false);
    ...
    public void cari() {
        ...
        Call<Response1Transfer> cari = api.bendaharaduatunai(Constans.getId_sekolah(), "Bearer " + Constans.getToken());
...
//                Log.d(TAG, "onResponse: " + barangs);
        ...
        Call<Response1Transfer> trans = api.bendaharaduatransfer(Constans.getId_sekolah(), "Bearer " + Constans.getToken());
