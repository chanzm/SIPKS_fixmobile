...
import id.ac.its.attendance.Konfirmasi.Kepala1Fragment;
...
public class TransferBarangActivity extends AppCompatActivity {
    ...
    Kepala1Fragment confirmFragment;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_transfer_barang);
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new SweetAlertDialog(TransferBarangActivity.this, SweetAlertDialog.WARNING_TYPE)
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                ...
                                confirmFragment = Kepala1Fragment.newInstance("Some Title");
    ...
    public void cari()
    {
        final SweetAlertDialog pDialog = new SweetAlertDialog(TransferBarangActivity.this, SweetAlertDialog.PROGRESS_TYPE);
        pDialog.getProgressHelper().setBarColor(Color.parseColor("#A5DC86"));
        pDialog.setTitleText("Loading");
        pDialog.show();
        ApiClientSIPKS api = ServerSIPKS.builder(TransferBarangActivity.this).create(ApiClientSIPKS.class);
            ...
            public void onResponse(Call<ResponseDetail> call, Response<ResponseDetail> response) {
                if (response.body().getPesan().equals("success"))
                {
                    ...
                    if (response.body().getDataDetail().getRekening().getNo_rekenig()!=null)
                    {
                        ...
                        nomor_rekening = response.body().getDataDetail().getRekening().getNo_rekenig();
                    }
                    barangs = response.body().getDataDetail().getBody();
                    if (barangs!=null ||! barangs.isEmpty()){
                        adapterDetail = new AdapterDetail(barangs,TransferBarangActivity.this);
                        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(TransferBarangActivity.this);
                ...
                else
                {
                    ...
                    new SweetAlertDialog(TransferBarangActivity.this, SweetAlertDialog.WARNING_TYPE)
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sDialog) {
                                    sDialog.dismiss();
                                    Constans.quit(TransferBarangActivity.this);
                                    Constans.deleteCache(TransferBarangActivity.this);
                                }
                            }).show();
                }
    ...
    public  void kirimke()
    {
        ...
        Call<ResponseBendaharaBarang> barang = api.kirim(nomor_rekening,Constans.getRekening(),uang1);
        barang.enqueue(new Callback<ResponseBendaharaBarang>() {
            ...
            public void onResponse(Call<ResponseBendaharaBarang> call, Response<ResponseBendaharaBarang> response) {
                ...
                {
                    new SweetAlertDialog(TransferBarangActivity.this, SweetAlertDialog.ERROR_TYPE)
                            .setTitleText("Status")
        ...
        barang.enqueue(new Callback<ResponseBendaharaBarang>() {
            ...
            public void onResponse(Call<ResponseBendaharaBarang> call, Response<ResponseBendaharaBarang> response) {
                if (response.body().getPesan().equals("success"))
                {
                    ...
                    if (response.body().getUpdate().getHasil()!=null)
                    {
                        new SweetAlertDialog(TransferBarangActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                                .setTitleText("Status")
