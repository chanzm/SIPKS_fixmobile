...
import id.ac.its.attendance.Rule.Bendahara.Bos.Fragment.BGaji.AdapterGaji;
...
public class BBGajiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bbgaji, container, false);
        rc = view.findViewById(R.id.rc_bgaji_tunai);
        rc2=view.findViewById(R.id.rc_bgaji_transfer);
        kosong_tunai = view.findViewById(R.id.kosong_bgaji_tunai);
        kosong_transfer = view.findViewById(R.id.kosong_bgaji_transfer);
        swipeRefreshLayout = view.findViewById(R.id.bgaji);
    ...
    public void cari() {
        ...
        Call<Response1Transfer> cari = api.bendaharaduatunai1(Constans.getId_sekolah(), "Bearer " + Constans.getToken());
            ...
            public void onResponse(Call<Response1Transfer> call, Response<Response1Transfer> response) {
                if (response.body().getPesan().equals("success"))
                {
                    ...
                    if (barangs == null || barangs.isEmpty()) {
                        ...
                        adapterBarang = new AdapterGaji(barangs, getActivity());
...
//                Log.d(TAG, "onResponse: " + barangs);
        ...
        Call<Response1Transfer> trans = api.bendaharaduatransfer1(Constans.getId_sekolah(), "Bearer " + Constans.getToken());
            ...
            public void onResponse(Call<Response1Transfer> call, Response<Response1Transfer> response) {
                if (response.body().getPesan().equals("success"))
                {
                    ...
                    if (barang1 == null || barang1.isEmpty()) {
                        ...
                        adapterBarang = new AdapterGaji(barang1, getActivity());
                        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity());
